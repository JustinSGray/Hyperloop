...
\SupplementaryNotes{}
\Acknowledgment{Thanks to Scott Jones, Jeff Berton, Chris Heath and the rest of the RTM branch for contributing their expertise.}
...
and the system's design, modeling, analysis and optimization (MDAO) is approached from an aeronautic perspective. Therefore, the modeling is
...
capsule geometry have been identified that were not vetted in the original proposal. The results indicate that travel speeds around Mach 0.8 are
attainable, with a tube inner diameter approximately two times larger than originally proposed. In addition, some basic sizing estimates are made to quantify
the effect of the maximum speed on battery sizing and cooling requirements. The estimated on-board power
requirement of 3-5 Tesla Model-S sized batteries is in agreement with Musk's original proposal. Conversely, preliminary cooling calculations indicate
 steam tanks to be ineffective and possibly trivial in comparison to the heat exchange between the tube and surrounding environment.}  
