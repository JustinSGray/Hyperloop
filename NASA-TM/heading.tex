...
capsule geometry have been identified that were not vetted in the original proposal. The results indicate that travel speeds around Mach 0.85 are
attainable, while keeping tube size within reason. In addition, some basic sizing estimates are made to quantify the effect of the maximum speed
on battery sizing and cooling requirements based on the compression cycle and tube diameter.}   % suggested 200 words max
