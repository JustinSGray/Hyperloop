...
The Hyperloop is a conceptual transportation system aimed to lower costs and travel times relative to California's current high speed
 rail project. \cite{Musk} The idea was released in August 2013 as an open design concept to be vetted and further designed through public contribution.
 Despite receiving significant media attention, no further publications have yet been published on the subject.
 The design consists of a passenger pod traveling in a tube under partial vacuum at ground level and near sonic
...
pod at a relative velocity equal to the pod speed and as the air is forced through the smaller bypass area around the pod,
it accelerates. Assuming a circular cross section for both the pod and tube, then the bypass air must travel through an area given by
...
bypass air throughput; and increasing the inlet diameter harms the bypass area at a more than it improves
