...
electromagnetic accelerators mounted to the tube and the entire system being held above ground on concrete 
...
a crowd sourced design effort. In that spirit, all of the analyses used in this work have been released under
...
This increase is strongly dependent on the amount of "blockage" assumed and is also slightly dependent on the compressor face Mach number.
Changing the compressor face Mach number by $\pm$ 0.05 changes the maximum pod Mach number by roughly $\pm$ 0.01.
