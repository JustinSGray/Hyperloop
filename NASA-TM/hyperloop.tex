...
<<<<<<< HEAD
step to performing a design optimization of Hyperloop with the dual objectives of minimizing ticket cost and travel time.
=======
step to performing a design optimziation of Hyperloop with the dual objectives of minimizing ticket cost and travel time.
>>>>>>> b8539a66e8ef87560e8e716ec262d7bb51cf4ebc
...
pod geometry breakdown into 5 subsystem. Most of these calculations were based on simple geometric relationships. The 
...
where cycles get broken down into individual thermodynamic processes and then connected together. The modularity in NPSS naturally translated 
into the subassembly structure for the compressor cycle. 
...
All analysis models used for this work were built exclusively using open-source tools. 
The fully integrated system model was constructed using OpenMDAO, a Python based framework for 
the design and optimization of complex systems\cite{GrayBenmarking2013}. 
...
These methods were adopted for pyCycle, the cycle modeling tool used in this work.  PyCycle is an open-source cycle analysis 
tool that employs Cantera\cite{goodwin2009cantera} for thermodynamic calculations. 
