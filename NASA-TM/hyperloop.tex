...
\begin{enumerate}
  ...
  \item Pod Geometry: Physical dimensions of the pod.
  \item Tube Flow Limitations: Pod speed limitations based on choked flow restrictions between the pod and the tube.
  \item Tube Wall Temperature: Equilibrium temperature of the tube wall.
\end{enumerate}
