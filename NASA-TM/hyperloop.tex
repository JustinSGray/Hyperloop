...
analyses. All feed backs pass through the Compressor Cycle, which indicates that this system is of central importance
in the overall sizing process. 
...
The approach taken for modeling system was based heavily on existing techniques developed in the Numerical Propulsion System Simulation (NPSS) code. 
...
tool that employs Cantera for thermodynamic calculations. Further information on these tools can be found in the appendix and online documentation. \cite{Cantera}
