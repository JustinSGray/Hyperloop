...
in this work represent very basic analyses which rely heavily on simplifying assumptions. As
the Hyperloop concept evolves and the design process matures, more complex and detailed models 
will need to be employed to resolve finer details in the overall system. 
OpenMDAO could provide the means to manage growing model complexity in an efficient and flexible manner. 
Musks original work was released as an open design concept with the stated goal of jump starting
a crowd sourced design effort. In that spirit all the analyses used in this work were released 
the Apache V2.0 open source license so that they could potentially serve as a foundation for further 
work. 
